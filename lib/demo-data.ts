...
export const demoDevices: Device[] = [
  ...
  },
  {
    ...
    hostname: "ava-runner-01",
    ip: "192.0.2.52",
    ssid: "Thinkspace Ops",
    apName: "Seattle Lab AP-01",
    location: "Thinkspace Seattle",
    status: "agent_host",
  ...
  },
  {
    ...
    ip: "192.0.2.72",
    ssid: "Thinkspace Guest",
    apName: "Seattle Cafe AP-02",
    location: "Thinkspace Seattle",
    status: "claimed",
    riskState: "normal",
  ...
  },
  {
    ...
    ip: "192.0.2.88",
    ssid: "Thinkspace Member",
    apName: "Seattle Suite AP-02",
    location: "Thinkspace Seattle",
  ...
  },
  {
    ...
    ip: "192.0.2.12",
    ssid: "Thinkspace Staff",
    apName: "Seattle Lobby AP-01",
    location: "Thinkspace Seattle",
    status: "managed",
    riskState: "normal",
