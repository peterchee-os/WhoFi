...
import { buildSnapshotCaptureReport } from "@/lib/snapshot-report";
...
export async function GET(
  ...
  return new NextResponse(buildSnapshotCaptureReport(detail), {
    headers: {
      "Content-Disposition": `attachment; filename="whofi-capture-${id}.md"`,
