...
- The dashboard Usage view renders current snapshot totals, rollups, source-filtered recent snapshot history, stored capture detail, previous-capture deltas, new/missing device movement, and generated review-signal hints.
