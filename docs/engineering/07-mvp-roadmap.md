...
- The dashboard Usage view renders current snapshot totals, rollups, recent snapshot history, stored capture detail, previous-capture deltas, new/missing device movement, and generated review-signal hints.
