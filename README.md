...
Imported and demo profiles also feed local profile-link suggestions. When an unclaimed device hostname appears to match a known person, team, or organization, the ledger and inspector surface the suggested owner and the inspector offers an `Assign Suggested` action. These suggestions are evidence for operator review, not automatic ownership claims.
